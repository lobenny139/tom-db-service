...
@Component
@Service
public class DeviceCollectionDataDBAndCacheService extends EntityService<DeviceCollectionData, Long> implements IDeviceCollectionDataService {

    private static Logger logger = LoggerFactory.getLogger(DeviceCollectionDataDBAndCacheService.class);
