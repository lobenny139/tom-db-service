package com.tom.db.service.aop;

import com.tom.db.service.tool.AccessAspect;
...
public class EntityAccessAspect {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EntityAccessAspect.class);
